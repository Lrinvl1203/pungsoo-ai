...
5. 선택된 동물은 큰 몸선 하나와 귀·등선·꼬리·보폭 같은 종별 특징 두 개를 사용해 **25–38% 농도의 제2주제**로 통합한다.
...
이 10장은 7–23% 농도로 시험한 1차 기준선이다. 사용자 피드백을 반영한 다음 세대는 작품 70%·은호 30%를 기본으로 하고, 동물별 인지 난이도에 따라 25–38% 안에서 자동 조절한다. 사용자에게 화풍이나 동물 농도를 고르게 하지 않고 비방서가 전 과정을 결정한다.
